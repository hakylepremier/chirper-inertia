                ...
                <div className="flex justify-between items-center">
                    ...
                    {chirp.user.id === auth.user.id && (
                        <Dropdown>
                            ...
                            <Dropdown.Content>
                                <button
                                    className="block w-full px-4 py-2 text-left text-sm leading-5 text-white hover:bg-gray-100 focus:bg-gray-100
                                    hover:text-gray-800 
                                    focus:text-gray-800 transition duration-150 ease-in-out"
